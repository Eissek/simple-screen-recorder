...
schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__17457__auto__,k18787,else__17458__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k18787,else__17458__auto__);
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18786){
var self__ = this;
var G__18786__$1 = this;
return (new cljs.core.RecordIter((0),G__18786__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__17462__auto__,k__17463__auto__,G__18786){
var self__ = this;
var this__17462__auto____$1 = this;
var pred__18790 = cljs.core.keyword_identical_QMARK_;
var expr__18791 = k__17463__auto__;
if(cljs.core.truth_(pred__18790.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__18791))){
return (new schema.spec.leaf.LeafSpec(G__18786,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__17463__auto__,G__18786),null));
}
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__17454__auto__,G__18786){
var self__ = this;
var this__17454__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__18786,self__.__extmap,self__.__hash));
});
...
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__18788){
return (new schema.spec.leaf.LeafSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__18788),null,cljs.core.dissoc.call(null,G__18788,new cljs.core.Keyword(null,"pre","pre",2118456869)),null));
});
