...
schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5284__auto__,k10538,else__5285__auto__){
var self__ = this;
var this__5284__auto____$1 = this;
var G__10540 = (((k10538 instanceof cljs.core.Keyword))?k10538.fqn:null);
switch (G__10540) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k10538,else__5285__auto__);
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__10537){
var self__ = this;
var G__10537__$1 = this;
return (new cljs.core.RecordIter((0),G__10537__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5289__auto__,k__5290__auto__,G__10537){
var self__ = this;
var this__5289__auto____$1 = this;
var pred__10541 = cljs.core.keyword_identical_QMARK_;
var expr__10542 = k__5290__auto__;
if(cljs.core.truth_(pred__10541.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__10542))){
return (new schema.spec.leaf.LeafSpec(G__10537,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5290__auto__,G__10537),null));
}
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5281__auto__,G__10537){
var self__ = this;
var this__5281__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__10537,self__.__extmap,self__.__hash));
});
...
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__10539){
return (new schema.spec.leaf.LeafSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__10539),null,cljs.core.dissoc.call(null,G__10539,new cljs.core.Keyword(null,"pre","pre",2118456869)),null));
});
