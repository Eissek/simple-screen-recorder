...
while (G__20798__i < G__20798__a.length) {G__20798__a[G__20798__i] = arguments[G__20798__i + 0]; ++G__20798__i;}
  args = new cljs.core.IndexedSeq(G__20798__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__20799){
var args = cljs.core.seq(arglist__20799);
...
return cljs.core.get_in.call(null,new_db,p1__20800_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__20801_SHARP_){
return cljs.core.get_in.call(null,db,p1__20801_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__20802__i = 0, G__20802__a = new Array(arguments.length -  2);
while (G__20802__i < G__20802__a.length) {G__20802__a[G__20802__i] = arguments[G__20802__i + 2]; ++G__20802__i;}
  in_paths = new cljs.core.IndexedSeq(G__20802__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__20803){
var f = cljs.core.first(arglist__20803);
arglist__20803 = cljs.core.next(arglist__20803);
var out_path = cljs.core.first(arglist__20803);
var in_paths = cljs.core.rest(arglist__20803);
